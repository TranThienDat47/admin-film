...
const KeySeo = forwardRef(({ onCreateKey = () => {}, maxNumOfKey = 0, onChangeValue = () => {} }, ref) => {
         ...
         <div ref={ref} className={cx('inner-content-key_seo-create')}>
            ...
            <div style={{ overflow: 'hidden', borderRadius: '9px' }}>
               <Button
                  ...
                  disable={maxNumOfKey >= 0 ? (listKeyState && +listKeyState.length < +maxNumOfKey ? false : true) : true}
               >
